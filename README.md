...
- **Arrhenius Fit**: interactive ln t vs. 1/T plot where you can add/remove cure-time points (min. five), with live linear regression to back out $E_a$ and $k_0$ for your enamel system.
